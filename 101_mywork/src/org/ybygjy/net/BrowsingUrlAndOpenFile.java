...
public class BrowsingUrlAndOpenFile {
    ...
    public static void main(final String[] args) throws IOException {
        ...
        // DesktopUtil.browseAndWarn(new URL("http://163.com/"), null);
        // DesktopUtil.openAndWarn(new File("C:/wt.txt"), null);
        DesktopUtil.openAndWarn(new File("C://ABCDEF.xls"), null);
    }
}
...
class DesktopUtil {
    ...
    private static final String[] UNIX_BROWSE_CMDS = {"www-browser", // debian
            // update-alternatives
            // target
            "firefox", "opera", "konqueror", "epiphany", "mozilla", "netscape", "w3m", "lynx"};

    private static final String[] UNIX_OPEN_CMDS = {"run-mailcap", // many
            // Unixes,
            // run
            // registered
            // program
    ...
    /**
     * Launches the given URL and throws an exception if it couldn't be
     * launched.
     * @param url the URL to open
     * @throws IOException if a browser couldn't be found or if the URL failed
     *             to launch
     */
    ...
    /**
     * Launches the given URL and shows a dialog to the user if a browser
     * couldn't be found or if the URL failed to launch.
     * @param url the URL to open
     * @param parentComponent The parent Component over which the error dialog
     *            should be shown
     */
    ...
    /**
     * Launches the given URL and shows a dialog to the user if a browser
     * couldn't be found or if the URL failed to launch. This version takes a
     * String and handles the warning of malformed URLs where needed.
     * @param url the URL to open
     * @param parentComponent The parent Component over which the error dialog
     *            should be shown
     */
    ...
    private static void openWindows(final File file) throws IOException {
        ...
        Runtime.getRuntime().exec(
            new String[] {"rundll32", "shell32.dll,ShellExec_RunDLL", file.getAbsolutePath()});
    }
