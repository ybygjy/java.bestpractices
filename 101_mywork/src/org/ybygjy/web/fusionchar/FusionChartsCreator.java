...
public class FusionChartsCreator {
     ...
     * @param addNoCacheStr - Whether to add aditional string to URL to disable
     *            caching of data
...
System.out.println("cacheToDataURL:" + cachedURL);
        return cachedURL;
    }
     ...
     * @param chartSWF - SWF File Name (and Path) of the chart which you intend
     *            to plot
     * @param strURL - If you intend to use dataURL method for this chart, pass
     *            the URL as this parameter. Else, set it to "" (in case of
     *            dataXML method)
     * @param strXML - If you intend to use dataXML method for this chart, pass
     *            the XML data as this parameter. Else, set it to "" (in case of
     *            dataURL method)
     * @param chartId - Id for the chart, using which it will be recognized in
     *            the HTML page. Each chart on the page needs to have a unique
     *            Id.
     ...
     * @param registerWithJS - Whether to ask chart to register itself with
     *            JavaScript
     */
...
System.out.println("createChart:" + strBuf.toString());
     ...
     * @param debugMode - Whether to start the chart in debug mode
     */
    public static String createChartHTML(String chartSWF, String strURL, String strXML, String chartId,
                                         int chartWidth, int chartHeight, boolean debugMode) {
        String strFlashVars = "";
        Boolean debugModeBool = new Boolean(debugMode);
        ...
        if (strXML.equals("")) {
            // DataURL Mode
            strFlashVars = "chartWidth=" + chartWidth + "&chartHeight=" + chartHeight + "&debugMode="
                + boolToNum(debugModeBool) + "&dataURL=" + strURL + "";
        } else {
            // DataXML Mode
            strFlashVars = "chartWidth=" + chartWidth + "&chartHeight=" + chartHeight + "&debugMode="
                + boolToNum(debugModeBool) + "&dataXML=" + strXML + "";
        }
        StringBuffer strBuf = new StringBuffer();
        ...
        System.out.println("createChartHTML" + strBuf.toString());
        return strBuf.substring(0);
    }
