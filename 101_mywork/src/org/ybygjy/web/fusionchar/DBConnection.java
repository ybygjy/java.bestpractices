 ...
 * This class contains database specific code to connect to the database Access
 * or MySQL<br>
 * Only one instance of this class should ideally be used throughtout your
 * application.<br>
 * For demo purpose, we have kept the default constructor available to all
 * classes.<br>
 * Ideally you would override the default constructor and write a getInstance
 * method which will<br>
 * return a single DBConnection instance always,thus making it a singleton
 * class.<br>
 * In the current application,<code>InitServlet</code> instantiates this class
 * and sets all the <br>
 * variables like dbName,accessDBPath & mySQLDSN and puts that instance in the
...
public class DBConnection {
     ...
     * @return Connection - a connection to the specific database based on the
     *         configuration
     */
    ...
    /**
     * Gets a connection to the specific database as given in configuration
     * file.<br>
     ...
     * @return Connection - a connection to the database given in configuration
     *         file of the server.
     */
     ...
     * In real world applications,some kind of exception-handling needs to be
     * done.<br>
     * Further,in real world applications,some sort of connection pooling
     * mechanism <br>
     * would be used for getting the connection and proper care would be taken
     * to<br>
     * close it when the work is done.
